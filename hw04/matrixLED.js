    /* modified by Boyu Zhang 9/26/2016 */
	var socket;
    ...
    for (var j = 7; j >= 0; j--) {
        ...
        for (var i = 0; i < 8; i++) {
            matrixData += '<td><div class="LED" id="id' + i + '_' + j +
                '" onclick="greenLEDclick(' + i + ',' + j + ')" oncontextmenu="redLEDclick(' + i + ',' + j + '); return false;">' +
                i + ',' + j + '</div></td>';
        }
        matrixData += '</tr>';
    }
    ...
    function greenLEDclick(i, j) {
        ...
        if (disp[i] >> j & 0x1 === 1) {
            ...
            var classname = $('#id' + i + '_' + j).attr('class');
            if (classname == 'LED red') {
    ...
    */
    ...
    function matrix(data) {
        ...
        for (i = 0; i < disp.length; i++) {
            ...
            for (j = 0; j < 8; j++) {
                var classname = $('#id' + i + '_' + j).attr('class');
                if (classname == 'LED green red'||classname == 'LED red green' ) {
                    $('#id' + i + '_' + j).removeClass('red');
                    $('#id' + i + '_' + j).removeClass('green');
                    $('#id' + i + '_' + j).addClass('yellow');
                }
